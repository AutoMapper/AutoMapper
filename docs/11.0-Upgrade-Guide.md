...
These were older attributes, unrelated to the newer attributes API. You can also switch to the fluent API or implement the attributes in your own code. Check the tests for an example.
