...
namespace AutoMapper.UnitTests
{
    public class XpressionMapperTests
    {
        ...
        public void Map_includes_list()
        {
            ...
            //Act
            IList<Expression<Func<User, object>>> selectionsMapped = selections.Select(_ => mapper.Map<Expression<Func<User, object>>>(_)).ToList();
        ...
        {//Probebly want to be careful about mapping strings or value types to reference types.  What it there are multiple strings in the expression?
            ...
            //Act
            Expression<Func<User, IEnumerable<Car>>> selectionMapped = mapper.Map<Expression<Func<User, IEnumerable<Car>>>>(selection);
