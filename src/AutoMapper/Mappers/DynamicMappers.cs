...
namespace AutoMapper.Mappers
{
    ...
    public class FromDynamicMapper : IObjectMapper
    {
        ...
        {
            return Expression.Call(null, MapMethodInfo.MakeGenericMethod(sourceExpression.Type, destExpression.Type), sourceExpression, destExpression, contextExpression, DelegateFactory.CreateCtorExpression(destExpression.Type).ToType(destExpression.Type));
        }
    }
