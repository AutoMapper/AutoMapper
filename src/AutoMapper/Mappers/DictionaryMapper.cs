    ...
    public class DictionaryMapper : IObjectMapper
	{
		...
		public object Map(ResolutionContext context, IMappingEngineRunner mapper)
		{
			...
			foreach (object keyValuePair in keyValuePairs)
			{
				...
				TypeMap keyTypeMap = mapper.ConfigurationProvider.ResolveTypeMap(sourceKey, null, sourceKeyType, destKeyType);
				TypeMap valueTypeMap = mapper.ConfigurationProvider.ResolveTypeMap(sourceValue, null, sourceValueType, destValueType);
