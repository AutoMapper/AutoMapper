...
namespace AutoMapper.Configuration.Conventions
{
    public class CaseSensitiveName : ISourceToDestinationNameMapper
    {
        ...
        public virtual MemberInfo GetMatchingMemberInfo(IGetTypeInfoMembers getTypeInfoMembers, TypeDetails typeInfo, Type destType, Type destMemberType, string nameToSearch)
        {
            return
