...
namespace AutoMapper.Configuration.Conventions
{
    public interface IMemberConfiguration
    {
        ...
        bool MapDestinationPropertyToSource(ProfileMap options, TypeDetails sourceType, Type destType, Type destMemberType, string nameToSearch, LinkedList<MemberInfo> resolvers, bool reverseNamingConventions);
    }
}