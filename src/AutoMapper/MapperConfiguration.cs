        ...
        struct MapperFuncs
        {
            ...
            private static LambdaExpression GenerateObjectMapperExpression(MapRequest mapRequest, IObjectMapper mapperToUse, MapperConfiguration mapperConfiguration)
            {
                ...
                else if (mapperToUse is IObjectMapExpression)
                {
                    ...
                    var map = exprMapper.MapExpression(mapperConfiguration._typeMapRegistry, mapperConfiguration, null, source, destination, context);
                    var mapToDestination = Lambda(map, source, destination, context);
