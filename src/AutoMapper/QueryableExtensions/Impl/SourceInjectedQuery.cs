namespace AutoMapper.QueryableExtensions.Impl
{
    ...
    {
        public SourceInjectedQuery(IQueryable<TSource> dataSource, IQueryable<TDestination> destQuery, IExpressionBuilder builder, IMapper mapper, SourceInjectedQueryInspector inspector = null)
        {
            Expression = destQuery.Expression;
            ElementType = typeof(TDestination);
            Provider = new SourceInjectedQueryProvider<TSource, TDestination>(builder, mapper, dataSource, destQuery)
            {
