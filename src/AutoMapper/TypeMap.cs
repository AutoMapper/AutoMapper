...
namespace AutoMapper
{
    ...
    public class TypeMap
    {
        ...
        {
            return ConstructorMap?.CtorParams.Any(c => !c.DefaultValue && c.Parameter.Name != null && c.Parameter.Name.Equals(destinationPropertyName, StringComparison.OrdinalIgnoreCase)) == true;
        }
